...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    'App\\Repository\\ArtistRepository' => array('privates', 'App\\Repository\\ArtistRepository', 'getArtistRepositoryService.php', true),
    'App\\Repository\\ArtworkRepository' => array('privates', 'App\\Repository\\ArtworkRepository', 'getArtworkRepositoryService.php', true),
))));
